...
public class LostLuggage {
    ...
    public LostLuggage(String registrationNr, String dateLost, String timeLost, String luggageTag, int luggageType, String brand, int mainColor, int secondColor, int size, int weight, String otherCharacteristics, int passengerId, String Flight, String employeeId, int matchedId) {
